public class handphone extends perangkat {
    ...
    public void informasi(){
        if (this.fingerprint == true){
            System.out.printf("Handphone ini memiliki drive tipe %s dengan ram sebesar %d GB dan processor secepat %.2f Ghz. %nSelain itu handphone ini memiliki fingerprint", drive, ram, processor);
        }else{
